...
public class DivideMcTests
{
    ...
    public DivideMcTests()
    {
        ...
        for (int i = 0; i < 75; i++)
        {
            results[i] = new string[75];
        }
        initResults1();
        initResults2();
    }

    private void initResults1()
    {
        results[0][0] = "1";
        ...
        [Range(0, 74)] int j)
    {
        ...
        Assert.That(res1.toString(), Is.EqualTo( results[i][j]),
            $"Unexpected result from ({v1}).divide({v2}, MathContext.DECIMAL64); expected {results[i][j]} got {res1}");
    }
    
    [Test]
    public void mcDivideTests2()
    {
            ...
            for (int i = 0; i < value.Length; i++)
            {
                for (int j = 0; j < value.Length; j++)
                {
                    ...
                    Assert.That(res1, Is.EqualTo(res2), 
                        $"Unexpected result from {v1} / {v2}; expected {res2} got {res1}");
                }
            }
        }
    }
